...
import (
	...
	"user_context/rhombic/domain/account/service"
)
...
func (factory *Factory)InstanceOf()(ok bool){
	...
	if factory.Entity != nil {return}
	factory.Service = service.NewAccountService()
	if factory.Service == nil || factory.Service.Repository == nil || factory.Service.Publisher == nil {return}
